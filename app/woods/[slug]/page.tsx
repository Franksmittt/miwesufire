    ...
    <>
      ...
      <div className="pt-24 sm:pt-28 pb-5 sm:pb-6 px-4 sm:px-6 max-w-[1320px] mx-auto">
        <nav className="flex flex-wrap items-baseline gap-x-0 text-[0.75rem] sm:text-[0.8rem] text-gray-500 min-w-0">
          ...
          <span className="mx-1.5 sm:mx-2 shrink-0">/</span>
          <span className="text-ink truncate min-w-0 max-w-[140px] sm:max-w-none">{wood.name}</span>
        </nav>
      </div>

      {/* Hero: cinematic with title overlay */}
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 mb-8 sm:mb-12">
        <section className="relative w-full aspect-[16/9] sm:aspect-[21/9] min-h-[300px] sm:min-h-[360px] squircle overflow-hidden border border-[var(--rim)]">
        <Image
          src={images[0]}
      ...
      <main className="max-w-[1320px] mx-auto px-4 sm:px-6 pt-2 sm:pt-0 pb-20 sm:pb-24">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-12 sm:mb-16">
          <div className="squircle glass-panel p-4 sm:p-5 text-center">
            ...
            <p className="text-xs sm:text-sm text-muted leading-snug">{wood.burnProfile.heat.split(".")[0]}.</p>
          </div>
          <div className="squircle glass-panel p-4 sm:p-5 text-center">
            <p className="text-[10px] sm:text-xs font-bold text-cyan uppercase tracking-widest-tech mb-1">Coals</p>
            <p className="text-xs sm:text-sm text-muted leading-snug">{wood.burnProfile.coals.split(".")[0]}.</p>
          </div>
          <div className="squircle glass-panel p-4 sm:p-5 text-center">
            <p className="text-[10px] sm:text-xs font-bold text-ink uppercase tracking-widest-tech mb-1">Smoke</p>
            <p className="text-xs sm:text-sm text-muted leading-snug">{wood.burnProfile.smoke.split(".")[0]}.</p>
          </div>
          <div className="squircle glass-panel p-4 sm:p-5 text-center">
            <p className="text-[10px] sm:text-xs font-bold text-bronze uppercase tracking-widest-tech mb-1">Lighting</p>
            <p className="text-xs sm:text-sm text-muted leading-snug">{wood.burnProfile.lighting.split(".")[0]}.</p>
          </div>
        </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 mb-16 sm:mb-20">
          <div className="lg:col-span-2 flex flex-col justify-center">
            ...
            <p className="text-base sm:text-lg text-muted leading-[1.7]">
              {wood.intro}
            </p>
          </div>
          <div className="lg:col-span-3 squircle overflow-hidden border border-[var(--rim)] aspect-[4/3] lg:aspect-auto lg:min-h-[280px] relative">
        ...
        <section className="mb-16 sm:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5">
            <div className="md:col-span-7 squircle overflow-hidden border border-[var(--rim)] aspect-[16/10] relative">
              <Image src={images[2]} alt={`${wood.name} firewood – the look`} fill className="object-cover" sizes="(max-width: 768px) 100vw, 58vw" />
            </div>
            <div className="md:col-span-5 squircle overflow-hidden border border-[var(--rim)] aspect-[4/3] md:aspect-auto md:min-h-[200px] relative">
            ...
            <div className="md:col-span-6 squircle glass-panel p-5 sm:p-6">
              <h3 className="text-xs font-bold text-ink uppercase tracking-wide mb-2">Bark &amp; shape</h3>
              <p className="text-sm text-muted leading-relaxed">{wood.appearance.bark}</p>
              {wood.appearance.shape && (
                <p className="text-sm text-muted leading-relaxed mt-3">{wood.appearance.shape}</p>
              )}
            </div>
            <div className="md:col-span-6 squircle glass-panel p-5 sm:p-6">
              <h3 className="text-xs font-bold text-ink uppercase tracking-wide mb-2">Heartwood &amp; sapwood</h3>
              <p className="text-sm text-muted leading-relaxed">{wood.appearance.heartwood}</p>
              <p className="text-sm text-muted leading-relaxed mt-3">{wood.appearance.sapwood}</p>
            </div>
            <div className="md:col-span-12">
              <p className="text-xs text-muted border border-[var(--rim)] rounded-2xl px-4 py-3 inline-block">
                <span className="text-ink font-semibold">Quick ID:</span> {wood.identifier}
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6 mb-6">
            <div className="lg:col-span-2 squircle overflow-hidden border border-[var(--rim)] aspect-[2/1] relative">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="squircle glass-panel p-4 sm:p-5 border-l-2 border-ember">
                ...
                <p className="text-sm text-muted leading-snug">{wood.burnProfile.heat}</p>
              </div>
              <div className="squircle glass-panel p-4 sm:p-5 border-l-2 border-cyan">
                ...
                <p className="text-sm text-muted leading-snug">{wood.burnProfile.coals}</p>
              </div>
              <div className="squircle glass-panel p-4 sm:p-5 border-l-2 border-ink/40">
                <p className="text-[10px] font-bold text-ink uppercase tracking-widest-tech mb-1.5">Smoke</p>
                <p className="text-sm text-muted leading-snug">{wood.burnProfile.smoke}</p>
              </div>
              <div className="squircle glass-panel p-4 sm:p-5 border-l-2 border-bronze">
                ...
                <p className="text-sm text-muted leading-snug">{wood.burnProfile.lighting}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
            {wood.bestFor.map((use, i) => (
              <div
                key={use}
                className="squircle glass-panel p-5 sm:p-6 flex items-start gap-4 group hover:border-ember/40 transition-colors"
              >
                <span className="flex-shrink-0 w-10 h-10 rounded-xl bg-ember/10 border border-ember/30 flex items-center justify-center text-ember font-bold text-lg">
                  {i + 1}
                </span>
                <p className="text-sm sm:text-base text-muted leading-snug pt-0.5">{use}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-20">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            <div className="squircle overflow-hidden border border-[var(--rim)] aspect-square relative">
        ...
        {wood.inOurRange ? (
          <section className="squircle overflow-hidden border border-ember/30 bg-gradient-to-br from-ember/10 to-transparent p-8 sm:p-10 md:p-12 text-center">
            <h2 className="font-display text-xl sm:text-2xl font-semibold text-ink mb-3">Get {wood.name}</h2>
            <p className="text-muted max-w-xl mx-auto mb-6">
              {wood.inOurRange}
            </p>
            <Link
              href="/#products"
              className="inline-flex items-center justify-center min-h-[52px] py-3 px-8 rounded text-sm font-semibold tracking-wide bg-ember text-white hover:bg-[var(--ember-deep)] transition-colors no-underline"
            >
              View products
            </Link>
          </section>
          ...
          <section className="squircle glass-panel p-8 sm:p-10 text-center">
            <h2 className="font-display text-xl sm:text-2xl font-semibold text-ink mb-3">Want {wood.name}?</h2>
            ...
            <a
              ...
              className="inline-flex items-center justify-center min-h-[48px] py-2.5 px-6 rounded text-sm font-semibold tracking-wide border border-[var(--rim-strong)] text-ink hover:bg-ground transition-colors no-underline"
            >
              Contact us
            </a>
          </section>
        ...
        <nav className="flex flex-wrap gap-6 pt-12 border-t border-[var(--rim)]">
          <Link href="/woods" className="text-sm text-muted no-underline hover:text-bronze transition-colors">
            ← All woods
          </Link>
          <Link href="/#products" className="text-sm text-muted no-underline hover:text-bronze transition-colors">
            View all products
          </Link>
        </nav>
      </main>
