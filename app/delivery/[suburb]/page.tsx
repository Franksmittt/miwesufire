  ...
  return (
    <>
      ...
      <main className="pt-14 max-w-[1320px] mx-auto py-12 sm:py-16 px-4 sm:px-6">
        <h1 className="text-[clamp(1.75rem,4vw,2.5rem)] font-bold tracking-tight text-center mb-4">
          Engineered Heat for {config.areaName}
        </h1>
        <p className="text-[var(--titanium)] text-center text-[1rem] sm:text-[1.05rem] mb-8">
          {config.tagline}
        </p>
        ...
        <p className="mt-10 text-[0.875rem] text-[var(--titanium)]">
