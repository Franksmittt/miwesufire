...
export const PRODUCTS: Product[] = [
  // 10kg pricing (MOQ unchanged): Braai Mix R35, Geelhaak R35, Sekelbos R35
  {
    ...
    images: ["/geelhaak_10kg01.png", ...FALLBACK_GEELHAAK],
    price: 35,
    moq: 50,
    priceLabel: "R35.00 per bag",
  },
  {
    id: "braai-mix-10",
    ...
    images: ["/ultimate_braai_mix_10kg01.png", ...FALLBACK_BRAAI],
    price: 35,
    moq: 50,
    priceLabel: "R35.00 per bag",
  },
  {
    ...
    images: ["/sekelbos_10kg01.png", ...FALLBACK_SEKELBOS],
    price: 35,
    moq: 50,
    priceLabel: "R35.00 per bag",
  },
  // 20kg pricing (MOQ unchanged): Geelhaak R50, Braai Mix R55, Sekelbos R70
  {
    id: "geelhaak-20",
    name: "Geelhaak Hardwood",
    tier: "20kg Bag",
    shortDescription: GEELHAAK_DESC,
    longDescription: GEELHAAK_LONG,
    images: ["/geelhaak_20kg01.png", ...FALLBACK_GEELHAAK],
    price: 50,
    moq: 40,
  ...
  },
  {
    ...
    shortDescription: BRAAI_MIX_DESC,
    longDescription: BRAAI_MIX_LONG,
    images: ["/ultimate_braai_mix_20kg01.png", ...FALLBACK_BRAAI],
    price: 55,
    moq: 40,
    priceLabel: "R55.00 per bag",
  },
  {
    id: "sekelbos-20",
    name: "Premium Sekelbos",
    ...
    shortDescription: SEKELBOS_DESC,
    longDescription: SEKELBOS_LONG,
    images: ["/sekelbos_20kg01.png", ...FALLBACK_SEKELBOS],
    price: 70,
    moq: 40,
  ...
  // 30kg pricing (MOQ unchanged): Geelhaak R70, Braai Mix R75, Sekelbos R90
  {
    ...
    shortDescription: GEELHAAK_DESC,
    longDescription: GEELHAAK_LONG,
    images: ["/geelhaak_30kg01.png", ...FALLBACK_GEELHAAK],
    price: 70,
    moq: 20,
    priceLabel: "R70.00 per bag",
  },
  {
    ...
    shortDescription: BRAAI_MIX_DESC,
    longDescription: BRAAI_MIX_LONG,
    images: ["/ultimate_braai_mix_30kg01.png", ...FALLBACK_BRAAI],
    price: 75,
    moq: 20,
  ...
  },
  {
    ...
    shortDescription: SEKELBOS_DESC,
    longDescription: SEKELBOS_LONG,
    images: ["/sekelbos_30kg01.png", ...FALLBACK_SEKELBOS],
    price: 90,
    moq: 20,
